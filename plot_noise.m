...
hold on;
box on;
plot(I, errs_clean(1, 1:numel(I)), 'ro-', 'LineWidth', 2);%kr
plot(I, errs_clean(2, 1:numel(I)), 'bs-', 'LineWidth', 2);%cosamp
plot(I, errs_clean(3, 1:numel(I)), 'k^-', 'LineWidth', 2);%omp
plot(I, errs_clean(4, 1:numel(I)), 'cp-', 'LineWidth', 2);%akron
plot(I, errs_clean(5, 1:numel(I)), 'ms-', 'LineWidth', 2);%akronoi
plot(I, errs_clean(6, 1:numel(I)), 'rs-', 'LineWidth', 2);%l1
